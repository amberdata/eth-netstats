var pg = require('pg');
var pgconnectionString = process.env.DATABASE_URL || 'postgres://peng:peng@localhost:5432/todo';
...
History.prototype.getBlockPropagation = function()
{
  ...
  console.log('propagation = '+JSON.stringify(propagation));
	if(propagation.length > 0)
	{
		...
		//   'INSERT INTO block_propagation(time_millis_array) values($1)', [propagation]);
	}
